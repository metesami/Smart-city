...
# این ورژن سختگیرانس که هارد و سافت فلگ ها رو حذف کرده و مجددا سافت فلگ های 
ZERO_RUN_SHORTو PROFILE_SOFT
# رو با استفاده از اینپوت کلین شده بازسازی میکنه و بعد ایمپوت میکنه فقط برای
import os
import re
import json
